                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-success my-auto float-end"> <i class="feather feather-shopping-bag"></i> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-secondary brround my-auto float-end"> <i class="feather feather-users"></i> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
