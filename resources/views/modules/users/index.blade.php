    ...
    <div class="side-app">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <h4 class="page-title"> @if(request('trashed')) Deleted @endif Users List</h4>
            </div>
        ...
        <div class="row">
                ...
                <div class="card">
                    <a href="#">
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg bradius fs-20 bg-primary-transparent">{{ $totalUsersCount
                                }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12">
                <div class="card">
                    <a href="#">
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg bradius fs-20 bg-success-transparent">{{ $activeUsersCount
                                }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12">
                <div class="card">
                    <a href="#">
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg bradius fs-20 bg-danger-transparent">{{ $inactiveUsersCount
                                }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12">
                <div class="card">
                    <a href="#">
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg bradius fs-20 bg-secondary-transparent">{{ $trashedUsersCount
                                }}</span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="dob" class="form-control fc-datepicker" placeholder="DD-MM-YYYY"
                                            type="date">
                                    </div>
                                </div>
                            </div>
